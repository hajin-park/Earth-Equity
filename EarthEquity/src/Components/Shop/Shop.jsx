...
import { ChevronUpDownIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, EllipsisHorizontalIcon, CheckIcon } from '@heroicons/react/20/solid'
    ...
    <div className="bg-white sm:py-10">
      <div className="mx-auto max-w-7xl px-3 lg:px-5">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-base font-semibold leading-7 text-indigo-600">Your Equity Purchase</h2>
        ...
        <div className="isolate mx-auto mt-16 grid max-w-md grid-cols-1 sm:mt-5 lg:mx-0 lg:max-w-none">
          ...
          <Listbox value={selected} onChange={setSelected}>
            {({ open }) => (
              <>
                <Listbox.Label className="block text-sm font-medium leading-6 text-gray-900">Select Duration:</Listbox.Label>
