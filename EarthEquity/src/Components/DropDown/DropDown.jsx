...
export default function DropDown({ market, options }) {
    return (
        <Menu as="div" className="relative inline-block text-left">
            ...
            >
                <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md shadow-lg focus:outline-none">
                    {options.map((option) => {
                        <div className="py-1">
                            <Menu.Item>
                                {({ active }) => (
